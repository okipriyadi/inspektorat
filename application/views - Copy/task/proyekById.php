...
<div class="row body-low-bg ">
	<div class="col-md-12 content-dalam">
		<div class="row">
					<div class="col-md-9" style="box-shadow: 2px 2px 8px #000000,  0 0 5px #b5cdf2;">
					...
					<div class="col-md-3">
							<div class=" task-board" >
								<button class="btn btn-primary"><i class="fa fa-plus"> Status</i></button>
								<button class="btn btn-success"><i class="fa fa-plus"> Pekerjaan</i></button>
								<br>
								<br>
