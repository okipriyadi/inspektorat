    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 col-md-3">
                <div class="single-video-post">
                    <div class="video-post-thumb">
                        <img src="<?php echo base_url() ?>assets/template/img/blog-img/4.jpg" alt="">
            ...
            <div class="col-12 col-md-3">
                <div class="single-video-post">
                    <div class="video-post-thumb">
                        <img src="<?php echo base_url() ?>assets/template/img/blog-img/5.jpg" alt="">
                        <a href="https://youtu.be/dIyXl9ZHEgg" class="videobtn"><i class="fa fa-play" aria-hidden="true"></i></a>
                    </div>
            ...
            <div class="col-12 col-md-3">
                <div class="single-video-post">
                    <div class="video-post-thumb">
                        <img src="<?php echo base_url() ?>assets/template/img/blog-img/6.jpg" alt="">
                        <a href="https://youtu.be/dIyXl9ZHEgg" class="videobtn"><i class="fa fa-play" aria-hidden="true"></i></a>
                    </div>
            ...
            <div class="col-12 col-md-3">
                <div class="single-video-post">
                    <div class="video-post-thumb">
                        <img src="<?php echo base_url() ?>assets/template/img/blog-img/7.jpg" alt="">
                        <a href="https://youtu.be/dIyXl9ZHEgg" class="videobtn"><i class="fa fa-play" aria-hidden="true"></i></a>
                    </div>
            ...
            <div class="col-12 col-md-3">
                <div class="single-video-post">
                    <div class="video-post-thumb">
                        <img src="<?php echo base_url() ?>assets/template/img/blog-img/8.jpg" alt="">
                        <a href="https://youtu.be/dIyXl9ZHEgg" class="videobtn"><i class="fa fa-play" aria-hidden="true"></i></a>
                    </div>
            ...
            <div class="col-12 col-md-3">
                <div class="single-video-post">
                    <div class="video-post-thumb">
                        <img src="<?php echo base_url() ?>assets/template/img/blog-img/9.jpg" alt="">
                        <a href="https://youtu.be/dIyXl9ZHEgg" class="videobtn"><i class="fa fa-play" aria-hidden="true"></i></a>
                    </div>
            ...
            <div class="col-12 col-md-3">
                <div class="single-video-post">
                    <div class="video-post-thumb">
                        <img src="<?php echo base_url() ?>assets/template/img/blog-img/10.jpg" alt="">
                        <a href="https://youtu.be/dIyXl9ZHEgg" class="videobtn"><i class="fa fa-play" aria-hidden="true"></i></a>
                    </div>
            ...
            <div class="col-12 col-md-3">
                <div class="single-video-post">
                    <div class="video-post-thumb">
                        <img src="<?php echo base_url() ?>assets/template/img/blog-img/11.jpg" alt="">
                        <a href="https://youtu.be/dIyXl9ZHEgg" class="videobtn"><i class="fa fa-play" aria-hidden="true"></i></a>
                    </div>
